...
```{r}
if(params$pdf_mode){
  cat("View this CV online at https://rpubs.com/MetodiSimeonov/CV")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF](https://github.com/Met0o/Resume/SimeonovCV.pdf)")
}
```
...
Projects outside of work {data-icon=chart-line}
--------------------------------------------------------------------------------
